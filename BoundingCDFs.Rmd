...
K3n = mean(abs(scale(rt(Nrep, df = 5)))^3)
```
...
PreviousBound = 0.4690 * K3n / sqrt(n)
...
df_bounds_Student = data.frame(
  ...
  type = c(rep("True probability", nrow(cdf_Student_5df)),
           rep(c("New bounds", "New bounds", "Existing bounds", "Existing bounds"), each = length(x))),
